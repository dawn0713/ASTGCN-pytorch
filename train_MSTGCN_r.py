...
import argparse
import configparser
from model.MSTGCN_r import MSTGCN
...
params_path = os.path.join('../experiments1', dataset_name, folder_dir)
...
net = MSTGCN(DEVICE, nb_block, in_channels, K, nb_chev_filter, nb_time_filter, time_strides, adj_mx,
...
def predict_main(global_step, data_loader, data_target_tensor, _mean, _std, type):
    ...
    predict_and_save_results_mstgcn(net, data_loader, data_target_tensor, global_step, _std, params_path, type)

if __name__ == "__main__":

    train_main()

    # predict_main(24, test_loader, test_target_tensor, _mean, _std, 'test')
